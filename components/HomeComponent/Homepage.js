          ...
          <div className="  mt-[10em] px-10 relative">
            ...
            <div className="inset-0 flex items-end justify-start  ">
              <div className="bg-white absolute text-black p-5 rounded-tr-3xl rounded-bs-3xl border border-r border-black lg:w-1/3 ">
                <p>
                  ...
                  positive change, transcending boundaries and leaving a legacy
                  of hope.
                </p>
              </div>
            </div>
            ...
            <div className="inset-0 lg:flex items-end justify-end lg:me-10    ">
              <button
                ...
                className="focus:outline-none text-violet-600 absolute bg-[#F3D479] hover:bg-[#7e3f98] hover:text-yellow-200 focus:ring-4 focus:ring-yellow-200 font-normal rounded-3xl text-sm px-14 py-4 me-2 mb-14 dark:focus:ring-yellow-900"
              >
                Play the Video
              </button>
