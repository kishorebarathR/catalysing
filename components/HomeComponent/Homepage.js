    ...
    <>
      <div className="custom-container">
        <Slider {...settings}>
          ...
          <div className=" px-5 lg:relative -my-20">
            ...
            <div className="inset-0 flex items-end justify-start  ">
              <div className="bg-white lg:absolute text-black p-5 rounded-tr-3xl rounded-bs-3xl border border-r border-black lg:w-1/3 ">
                <p>
